  ...
  <div>
    ...
    >
      ...
      <el-table-column
        ...
        align="center"
      ></el-table-column>
      <el-table-column prop="supplyType" label="供应类型" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" width="180" fixed="right">
        <template slot-scope="scope">
          <!-- <el-button
            ...
            size="mini"
            type="text"
            @click="getDetail(scope.row.id,1)"
          >审核</el-button> -->
          ...
          <el-button
            v-if="
              ...
              scope.row.status == 3
            "
            :disabled="scope.row.changeStatus == 1"
            size="mini"
            type="text"
    ...
    >
      ...
      >
        ...
        <el-row type="flex" justify="end" align="middle">
          <el-button
            v-if="addValue.status != 2"
            plain
            @click="submitForm('detailForm', 'storage')"
            >暂存</el-button
          >
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td>公司类型：{{ searchTypeName(addValue.companyType, 1) }}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                供应类型：{{ searchTypeName(addValue.supplyType, 2) || "-" }}
              </td>
  ...
  methods: {
    ...
    setDetail (type) {
      if (type == "storage") {
        ...
        let myFunction;
        if (this.addValue.status == 3) {
          myFunction = change_apply;
        } else {
          myFunction = submit;
        }
